    ...
    return (
        <div className="navbar bg-base-100">
            <div className="flex-1">
                <a className="btn btn-ghost text-xl">Save Berita</a>
            </div>
            <div className="flex-none gap-2">
                ...
                <div className="dropdown dropdown-end">
                    ...
                    <ul
                        ...
                        {/* jika user tidak ada maka akan memunculkan login dan register */}
                        {!user ? 
                        <>
                        ...
                        :
                        // jita user ada maka akan memunculkan profil dkk                       
                        <>
                        <li>
